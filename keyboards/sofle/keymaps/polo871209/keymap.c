...
* `-----------------------------------------/       /     \      \-----------------------------------------'
*            |Hyper | LAltc | LCTR| LGUI | / SPACE /       \ Enter\  |_ARROW| _NUM | LCTR |  DEL |
*            |      |       |     |      |/       /         \      \ |      |      | Space|      |
*            `----------------------------------'           '------''---------------------------'
*/
...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MPLY,      KC_MUTE, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
              KC_HYPR,KC_LEFT_ALT,KC_LCTL, KC_LGUI, KC_SPC,           KC_ENT, MO(_ARROW), MO(_NUMBER), LCTL(KC_SPC), LGUI(KC_BSPC)
),
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |  <>  |  F11 |  F12 |   [  |   ]  |   \  |                    |      | HOME |  Up  |  END | Pause|  BS  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  |  F13 |  F14 |   {  |   }  |   |  |-------.    ,-------|  PUp | Left | Down | Rigth| PDown|      |
 * |------+------+------+------+------+------|  play |    | mute  |------+------+------+------+------+------|
 * |LShift|  F15 |  F16 |   <  |   >  |   =  |-------|    |-------|   +  | CLeft|      |CRigth|      |RShift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |Enter | LAltc | LCTR| LGUI | / SPACE /       \ Enter\  |_ARROW| _NUM | LCTR |  DEL | 
 *            |      |      |      |      |/       /         \      \ |      |      | Space|      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_ARROW] = LAYOUT(
  XXXXXXX,  KC_F1,  KC_F2,    KC_F3,   KC_F4,   KC_F5,                         KC_F6,         KC_F7,   KC_F8,         KC_F9,  KC_F10,  XXXXXXX,
  _______, KC_F11, KC_F12,  KC_LBRC, KC_RBRC, KC_BSLS,                       XXXXXXX,       KC_HOME,   KC_UP,        KC_END, XXXXXXX,  _______,
  _______, KC_F13, KC_F14, KC_LCBR,  KC_RCBR, KC_PIPE,                       KC_PGUP,       KC_LEFT, KC_DOWN,       KC_RGHT, KC_PGDN,  XXXXXXX,
  _______, KC_F15, KC_F16,   KC_LT,    KC_GT,  KC_EQL, _______,     _______, KC_PPLS, LALT(KC_LEFT), XXXXXXX, LALT(KC_RGHT), XXXXXXX,  _______,
...
[_NUMBER] = LAYOUT(
  ...
  _______, XXXXXXX,  XXXXXXX, KC_LBRC,  KC_RBRC, KC_BSLS,                           XXXXXXX,    KC_7,    KC_8,    KC_9, XXXXXXX, _______,
  _______, XXXXXXX,  XXXXXXX, KC_LCBR,  KC_RCBR, KC_PIPE,                           XXXXXXX,    KC_4,    KC_5,    KC_6, KC_COLN, KC_DQUO,
  _______, XXXXXXX,  XXXXXXX,   KC_LT,    KC_GT,  KC_EQL,  _______,        _______,    KC_0,    KC_1,    KC_2,    KC_3, KC_QUES, _______,
                    _______, _______, _______, _______, _______,             _______, _______, _______, _______, _______
)
};
// clang-format on
