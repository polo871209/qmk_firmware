...
enum sofle_layers { _QWERTY, _ARROW, _NUMBER, _MEDIA };
...
* |------+------+------+------+------+------|                    |------+------+------+------+------+------|
* | Tab  |HYPR A|LALT S|LSFT D|LCTL F|   G  |-------.    ,-------|   H  |RCTL J|RSFT K|RALT L|HYPR ;|  '   |
* |------+------+------+------+------+------|  play |    | mute  |------+------+------+------+------+------|
* | LSFT |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  | RSFT |
* `-----------------------------------------/       /     \      \-----------------------------------------'
*            |      |      | LCTL | LGUI | / SPACE /       \ Enter\  | _NUM |_MEDIA|      |     |
*            `------------------------------------'         '-----------------------------------'
*/
...
[_QWERTY] = LAYOUT(
  _______, _______,      _______,      _______,      _______,   _______,                _______, _______,      _______,     _______,       _______,         _______,
   ...
   KC_TAB, HYPR_T(KC_A), LALT_T(KC_S), LSFT_T(KC_D), LCTL_T(KC_F), KC_G,                   KC_H, RCTL_T(KC_J), RSFT_T(KC_K), RALT_T(KC_L), HYPR_T(KC_SCLN), KC_QUOT,
  KC_LSFT, KC_Z,         KC_X,         KC_C,         KC_V,         KC_B, KC_MPLY, KC_MUTE, KC_N, KC_M,         KC_COMM,      KC_DOT,       KC_SLSH,         KC_RSFT,
                                _______, _______, KC_LCTL ,KC_LGUI, KC_SPC,            LT(_ARROW, KC_ENT), MO(_NUMBER), MO(_MEDIA), _______, _______
),
...
[_ARROW] = LAYOUT(
  _______, _______, _______,  _______, _______, _______,                    _______,       _______, _______,       _______, _______,  _______,
  _______, _______, KC_PLUS,  KC_LCBR, KC_RCBR, KC_BSLS,                    _______,       KC_HOME,   KC_UP,        KC_END, _______,  _______,
  _______, _______, KC_EQUAL, KC_LBRC, KC_RBRC, KC_PIPE,                    _______,       KC_LEFT, KC_DOWN,       KC_RGHT, KC_COLN,  KC_DQUO,
  _______, _______, _______,  KC_LPRN, KC_RPRN, _______, _______,  _______, _______, LALT(KC_LEFT), _______, LALT(KC_RGHT), KC_QUES,  _______,
...
[_NUMBER] = LAYOUT(
  ...
  KC_TILD, KC_EXLM,   KC_AT,    KC_HASH,  KC_DLR, KC_PERC,                     KC_ASTR,     KC_4,    KC_5,    KC_6, KC_COLN, _______,
  _______, KC_CIRC, KC_AMPR, LCTL(KC_B), KC_UNDS, KC_MINS,  _______,  _______,    KC_0,     KC_1,    KC_2,    KC_3, _______, _______,
                     _______, _______, _______, _______, _______,      _______, _______, _______, _______, _______
),
