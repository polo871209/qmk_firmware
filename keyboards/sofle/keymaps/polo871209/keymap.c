...
[_QWERTYM] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MPLY,  KC_MUTE, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
        LCA(KC_LGUI),KC_LEFT_ALT,KC_LCTL, KC_LGUI, KC_SPC,       KC_ENT, MO(_ARROW), MO(_NUMBER), DF(_QWERTYW), LGUI(KC_BSPC)
),
...
[_QWERTYW] = LAYOUT(
  ...
  KC_TAB,   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,  KC_QUOT,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MPLY,  KC_MUTE, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
         LCA(KC_LGUI),KC_LGUI,KC_LEFT_ALT,KC_LCTL, KC_SPC,       KC_ENT, MO(_ARROW), MO(_NUMBER), DF(_QWERTYM), KC_BSPC
),
...
static void print_status_narrow(void) {
    /* Print current mac/windows logo */
    oled_set_cursor(0, 1);
